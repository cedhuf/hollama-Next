...
| `src/i18n/`           | typesafe-i18n dictionaries, see [Translations](/llooma/development/translations/)                 |
...
on the [roadmap](/llooma/roadmap/) and would be a genuinely valuable contribution.
:::
...
- Commit messages follow [Conventional Commits](https://www.conventionalcommits.org). They are the
  input to the release, so they matter: see [Releases](/llooma/development/releases/).
