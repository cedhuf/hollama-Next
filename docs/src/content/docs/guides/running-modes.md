...
everything else follows from — where data lives, who can see it, and whether provider API keys
...
| Sharing settings      | —                                    | Admin can share and lock providers, prompts, tools |
