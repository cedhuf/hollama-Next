...
const en = {
	...
	mcpApprovalTimeoutHint: 'Unanswered, it is refused.',
	mcpStepRefused: 'You refused an external tool call',
	mcpServers: 'MCP servers',
	mcpServersDescription: 'Catalogues of tools running elsewhere, called from your conversations.',
	...
	mcpMaxToolsWarning:
		'{count:number} tool definitions ride along in every request of every turn where MCP is on.',
	mcpMaxToolsHint: 'Across every server switched on.',
	mcpNotAllowed: 'Your administrator has not opened MCP servers to this instance.',
	noMcpServers: 'No MCP server yet',
	addMcpServer: 'Add an MCP server',
	experimental: 'experimental',
	mcpProgressive: 'Announce the servers, not their tools',
	mcpProgressiveHint: 'The definitions of a server arrive only once the model asks for it.',
	mcpServerOptions: 'MCP server settings',
	deleteMcpServer: 'Delete this server',
	mcpServerUrl: 'Server address',
	mcpServerUrlHint: 'The HTTP streamable endpoint.',
	mcpToken: 'Token',
	mcpTokenHint: 'Sent as a bearer token on every call.',
	mcpEnabled: 'Use this server',
	mcpBlockedByAdmin: 'Suspended by the administrator.',
	...
	adminMcpDescription: 'Who may add one, and what has been added so far.',
