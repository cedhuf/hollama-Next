...
const fr = extendDictionary(en, {
	...
	baseUrl: 'URL de base',
	botIntegrations: 'Intégrations bot',
	botIntegrationsDescription:
		"Répondre en tant que bot sur un autre serveur de discussion. La conversation reste là-bas : rien n'est stocké ici.",
	addAnIntegration: 'Ajouter une intégration',
	noIntegrations: 'Aucune intégration pour le moment.',
	integrationEnabled: 'Activée',
	deleteIntegration: 'Supprimer cette intégration',
	chattoServer: 'Serveur Chatto',
	chattoServerHint: "L'adresse de votre serveur Chatto, par exemple https://chat.exemple.com",
	botApiKey: 'Clé API du bot',
	botApiKeyHint:
		'Créée dans Chatto sous Server Admin puis Bots. Affichée une seule fois, gardez-la avant de fermer.',
	checkConnection: 'Tester la connexion',
	connectedAsBot: 'Connecté en tant que {name:string}',
	botKeyRequired: 'Une clé API de bot est nécessaire',
	whoTheBotIs: 'Qui est le bot',
	customInstructions: 'Instructions personnalisées',
	instructionsDefault: 'Votre prompt système habituel',
	instructionsPersona: "Le prompt d'un persona",
	instructionsCustom: 'Écrites ici',
	instructionsDefaultHint: "Les mêmes instructions qu'au début d'une nouvelle conversation.",
	...
	placementThread: 'Toujours dans un fil',
	placementRoom: 'Toujours dans le salon',
	contextSent: 'Contexte envoyé au modèle',
	contextMention: 'Seulement le message qui appelle le bot',
	contextRecent: 'Les messages juste avant',
	contextThread: 'Tout le fil',
	contextSentHint:
		"Ce que le bot lit autour de l'appel. Le réglage le plus étroit n'envoie rien d'autre du salon.",
	howManyMessagesBefore: 'Combien de messages avant',
	checkEverySeconds: 'Vérifier toutes les (secondes)',
	...
	currency: 'Devise',
	priceTooltip: 'Coût en {currency:string}, {unit:string}',
	providerNeedsKey: 'Clé API',
	providerNoKey: 'Sans clé',
	providerOwnEndpoint: 'Votre propre adresse',
	searchProviders: 'Chercher un fournisseur',
	change: 'Changer',
	...
	perSecondShort: '/sec',
	perMinuteShort: '/min',
	priceUnitToken: 'Au million de jetons',
	...
	resetName: 'Revenir au nom du fournisseur',
	...
	resetToAuto: 'Tout remettre sur Auto',
	lowVram: 'Faible VRAM',
	...
	samplingMore: 'Autres paramètres',
	...
	sessionSystemPromptHelp:
		"Propre à cette conversation. Pré-rempli depuis vos prompts globaux et par modèle ; modifiez-le pour ne changer qu'ici.",
	sessionSystemPromptPlaceholder: 'Instructions pour cette conversation uniquement',
	overridden: 'remplacé',
	resetToSettingsDefault: 'Revenir à mes réglages',
	...
	voiceIdle: 'Touchez pour démarrer',
